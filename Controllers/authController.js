...
const {findOne, createUser, findById, update, updateUser, findallUsers, findUserByEmail} = require("../Query/Queries");
...
exports.updateProfile = async (req, res) => {
    ...
    const updateSchema = Joi.object({
        ...
        password: Joi.string().min(8).pattern(new RegExp("^[a-zA-Z0-9@!#$%^&*()_+={}\[\]|;:',<.>/?-]{3,30}$")),
    ...
    try {
        ...
        //     const isMatch=await bcrypt.compare(update.currentPassword,user.password)
        //     console.log(isMatch) 
        ...
        if(updateData.email){
            const user =  await findUserByEmail(updateData.email)
